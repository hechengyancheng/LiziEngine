...
class UIManager:
    ...
    def update_markers(self, grid: np.ndarray, move_factor: float = 0.001, damping_factor: float = 1.0):
        """使用标记系统更新标记位置
        ...
        Args:
            ...
            move_factor: 移动因子
        """
        self.marker_system.update_markers(grid, move_factor, damping_factor)
